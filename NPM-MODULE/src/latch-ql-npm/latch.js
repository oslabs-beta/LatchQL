...
class LatchQL {
    constructor(types, resolvers, redisConfig) {
        this.typeDefs = types;
        this.resolvers = resolvers;
        this.redisClient = redisConfig
            ? redis.createClient({
                socket: { host: redisConfig === null || redisConfig === void 0 ? void 0 : redisConfig.host, port: redisConfig === null || redisConfig === void 0 ? void 0 : redisConfig.port },
                password: redisConfig === null || redisConfig === void 0 ? void 0 : redisConfig.password,
            })
            : redis.createClient();
    ...
    async middleWare(resolve, root, args, context, info) {
        ...
        if (!context.alreadyRan) {
            ...
            const withinRateLimit = await this.rateLimiter(user_ip, costSum, rateLimit);
